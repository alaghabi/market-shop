...
final class SeedExtensionsCommand extends Command
{
    private const EXTENSIONS = [
        ...
        ['code' => 'boost_boutiques_1', 'name' => '+1 boutique', 'description' => 'Ajoute 1 boutique supplementaire a votre compte.', 'type' => ExtensionType::QuotaBoost, 'targetCode' => 'max_boutiques', 'value' => 1, 'priceTnd' => 5000, 'durationMonths' => 12, 'requiresValidation' => false, 'icon' => 'store'],
        ['code' => 'boost_boutiques_5', 'name' => '+5 boutiques', 'description' => 'Ajoute 5 boutiques supplementaires a votre compte.', 'type' => ExtensionType::QuotaBoost, 'targetCode' => 'max_boutiques', 'value' => 5, 'priceTnd' => 20000, 'durationMonths' => 12, 'requiresValidation' => false, 'icon' => 'store'],
